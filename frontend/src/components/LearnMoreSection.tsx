...
export default function LearnMoreSection() {
  return (
    <section
      id="learn-more"
      className="min-h-screen flex flex-col gap-y-10 justify-center items-center bg-sereniteBg/90 px-4 py-16"
    >
      <h2 className="text-3xl md:text-4xl font-bold text-sereniteTextLight mb-5">
        How does it work ?
      </h2>
      <p className="text-sereniteTextLight text-lg text-left max-w-xl mb-8 border-l-4 border-sereniteAccent pl-4 italic">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-4xl w-full">
        ...
        <div className="flex flex-col items-center text-center">
          <FaEdit className="text-4xl text-sereniteAccent mb-4" />
          <h3 className="text-white font-bold mb-2">
            Reflect Each Evening
          </h3>
          <p className="text-sereniteTextLight mb-4 text-sm">
        ...
        {/* Step 2 */}
        <div className="flex flex-col items-center text-center">
          <FaChartLine className="text-4xl text-sereniteAccent mb-4" />
          <h3 className="text-white font-bold mb-2">
            Track Your Growth
          </h3>
          <p className="text-sereniteTextLight mb-4 text-sm">
        ...
        {/* Step 3 */}
        <div className="flex flex-col items-center text-center">
          <FaRegSmileBeam className="text-4xl text-sereniteAccent mb-4" />
          <h3 className="text-white font-bold mb-2">
            Feel the Positivity
          </h3>
          <p className="text-sereniteTextLight mb-4 text-sm">
